                    ...
                    <div class='box-header red-background'>
                     <div class='title'><p>Matériels</p>
                        <div class='actions'>
                          ...
                          <a class="btn btn-md btn-link" href="MaterielAdd.php"><i class='icon-plus' ></i> Ajouter un matériel</a>
                        </div>
                       </div>
                    </div>
                      ...
                      <div class='responsive-table'>
                        ...
                        <div class='scrollable-area'>
                          <table id="example" class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0; width:100% !important;'>
                            <thead>
                              <tr><th>Photo</th><th>Nom</th><th>Description</th><th>Prix unitaire </th><th>Modifier</th><th>Supprimer</th></tr>
                            </thead>
                            <tbody>
                              <?php 
                              $dem=mysqli_query($connect,"SELECT * FROM MATERIAL"); 
                              ...
                              while($data=$dem->fetch_assoc()){
                               ...
                               // $customer_id=$data["CUSTOMER_ID"];
                                ...
                                if(is_file("../images/photo".$id.".jpg")){
                                  echo "<img class=\"img-responsive\" style=\"width:80px;margin:0 auto;\" src=\"../images/photo".$id.".jpg\">";
                                }elseif(is_file("../images/photo".$id.".png")){
                                   echo "<img class=\"img-responsive\" style=\"width:80px;margin:0 auto;\" src=\"../images/photo".$id.".png\">";
                                }else{
                                  echo "<img  class=\"img-responsive\" style=\"width:80px;margin:0 auto;\" src=\"../images/tools.png\">";
                                }                           
                                echo "</td><td class=\"name\" id=\"".$data["NAME"]."\">".$data["NAME"]."</td>
                                <td>".$data["DESCRIPTION"]."</td><td>".$data["UNIT_PRICE"]."&nbsp;CHF</td>
                                <td>
                                  <div class=\"text-right\">
                                    <a class=\"btn btn-warning btn-xs icon-a \" href=\"MaterielMod.php?id_mod=$id\">
                                      <i class=\"icon-edit\"></i>
                                    </a>
                                  </div>
                                </td>
...
<script src="https://cdn.datatables.net/responsive/2.1.1/js/responsive.jqueryui.min.js" type="text/javascript"></script>
    ...
    function suppclick(id, name){
        // alert(name);
         var message="<p>Voulez-vous vraiment supprimer ce matériel : '"+name+"'&nbsp;? <a class='btn btn-danger' id='oui'>OUI</a>&nbsp&nbsp;<a class='btn btn-danger' id='non'>NON</a></p>";
          ...
          $("#oui").click(function(){
             var envoi=$.post('removeMat.php',{id:id});
