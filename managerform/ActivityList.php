                    ...
                    <div class='box-header red-background'>
                     <div class='title'><p>Activités</p>
                        <div class='actions'>
                          ...
                          <a class="btn btn-md btn-link" href="ActivityAdd.php"><i class='icon-plus' ></i> Ajouter une activité</a>
                        </div>
                       </div>
                    </div>
                      ...
                      <div class='responsive-table'>
                        ...
                        <div class='scrollable-area'>
                          <table id="example" class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0; width:100%!important;'>
                            ...
                            <tbody>
                              <?php 
                              $dem=mysqli_query($connect,"SELECT * FROM ACTIVITY"); 

                              while($data=$dem->fetch_assoc()){
                                $id=$data["ACTIVITY_ID"];
                  
                                echo "<tr><td class=\"name\" id=\"".$data["NAME"]."\">".$data["NAME"]."</td><td>".$data["DESCRIPTION"]."</td> 
                                <td>
                                  <div class=\"text-right\">
                                    <a class=\"btn btn-warning btn-xs icon-a\" href=\"ActivityMod.php?id_mod=$id\">
                                      <i class=\"icon-edit\"></i>
                                    </a>
                                  </div>
                                </td>
...
<script src="https://cdn.datatables.net/responsive/2.1.1/js/responsive.jqueryui.min.js" type="text/javascript"></script>
	...
	function suppclick(id, name){
       // alert(name);
        var message="<p>Voulez-vous vraiment supprimer cette activite : '"+name+"'&nbsp;? <a class='btn btn-danger' id='oui'>OUI</a>&nbsp&nbsp;<a class='btn btn-danger' id='non'>NON</a></p>";
         ...
         $("#oui").click(function(){
            var envoi=$.post('removeAct.php',{id:id});
