			    ...
			    if(!empty($numeroRue)){
			      ...
			      if($address_id == 0){
			        ...
			        if($dem=mysqli_query($connect, $insert_address_sql)){
			            ...
			            if($id > 0){
			            	$update_organization_sql = "UPDATE ORGANIZATION_UNIT SET ADDRESS_ID='$address_id2' WHERE ORGANIZATION_UNIT_ID='$id'";
			            	$dem2=mysqli_query($connect,$update_organization_sql);
			            }
			            else{
			            	$address_insert_id = $address_id2;
			            }
        ...
        <div class='container'>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header red-background'>
                       <div class='title'><p>Organization:</p>
                       ...
                       if(!empty($message)){
                         ...
                         ?>
				<form class="form" style="margin-bottom: 0;" method="post" action="OrganizationUnitAdd.php" enctype="multipart/form-data" >
	                        <div class="col-sm-12">
	                        	<hr class="style_one"/>
					<input type="hidden" value="0" name="id" id="id" />
					<input type="hidden" name="address_insert_id1" value="<?php if($address_insert_id > 0) echo $address_insert_id; else echo "0";?>" />
					<div class='form-group'>
                        ...
                        <select class="form-control" id="organization_unit_type_id" name="organization_unit_type_id">
                        	...
                        	<option value="<?php echo $row['ORGANIZATION_UNIT_TYPE_ID']; ?>"><?php echo $row['NAME']?></option>
                        	<?php endwhile; endif;?>
                        </select>
                    </div>
                    <div class='form-group'>
                        <label for='organizatin_unit_name'>Nom</label>
                        <input class="form-control" id="organization_unit_name" name="organization_unit_name" placeholder="Organization Name" type="text">
                      </div>
					<div class='form-group'>
                    	<label for="desc_cus">Description</label>
                        <input type="text" class="form-control" id="description" name="description" placeholder="Organization Unit Description" />
                    </div>
					<div class='form-group'>
					...
					<div class='form-group'>
						...
						<select id="partent_organization_unit_id" name="partent_organization_unit_id" class="form-control">
                        	...
                        	<option value="<?php echo $row['ORGANIZATION_UNIT_ID']; ?>"><?php echo $row['NAME']?></option>
                        	<?php endwhile; endif;?>
						</select> 
					</div>
					<div class='form-group'>
						...
						<select id="schedule_id" name="schedule_id" class="form-control">
                        	...
                        	<option value="<?php echo $row['SCHEDULE_ID']; ?>"><?php echo $row['NAME']?></option>
                        	<?php endwhile; endif;?>
						</select> 
					</div>
							</div>
          ...
          <div class="col-sm-12" id="displayAddress">
             ...
             <form class="form" style="margin-bottom: 0;" method="post" action="#" enctype="multipart/form-data">   
             	<input type="hidden" name="address_insert_id" value="<?php if($address_insert_id > 0) echo $address_insert_id; else echo "0";?>" />
