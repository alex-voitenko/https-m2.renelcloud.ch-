...
if(isset($_GET["id_mod"])){
    ...
    $dem3=mysqli_query($connect,"SELECT * FROM CUSTOMER WHERE CUSTOMER_ID='$customer_id'");
   ...
   <hr class="style_one"/>
      <section id='content'>
        <div class='container'>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header red-background'>
                      <div class='title'><p>Modifier la mission : <?php echo $act_name; ?></p>
                 ...
                 ?>
                    ...
                    <div class='col-sm-12' >   
                      <div class='form-group'>
                        ...
                        <input class='form-control' id='wo_id' name='wo_id' type='hidden' value="<?php echo $wo_id; ?>">
                        <input class='form-control' id='wo_address_id' name='wo_address_id' type='hidden' value="<?php echo $wo_id; ?>">
                        <input class='form-control' id='act_name' name='act_name' type='text' value="<?php echo $act_name; ?>">
                      </div>
                    </div>
                    <div class='col-sm-12' >     
                      <div class='form-group'>
                  ...
                  <div class='col-sm-12' >     
                      <div class="form-group" id="choixAct">
                        <?php 
                          echo "<h3>Choix des activités : </h3>";
                     if(!empty($wo_id)){
                       ...
                       ?>
                       <label>Modifier les activités</label> 
             ...
             <div class='col-sm-6'>
                <div class='form-group'>
                  <h3>Date prévue : <?php echo $date_debut; ?></h3>
                    <label for='inputText'>Modifier date début </label> 
             ...
             <div class='col-sm-6'>
                <div class='form-group'>
                  <h3>Date prévue : <?php echo $date_fin; ?></h3>
                    <label for='inputText'>Modifier date Fin </label> 
          ...
          <div class='col-sm-12'>
           <div class='form-group'>
             ...
             <select class="form-control" name="state_wo">
                  <option value="0" selected="selected">Modifier le statut :</option>
                   <?php
                    ...
                    while($data=$req3->fetch_assoc()){
                        ...
                        echo "<option value=\"".$wo_status_id."\"";
                        if($wo_status_name==$status_name) echo "selected='selected'";
                        echo ">".$wo_status_name."</option>";
                    }    
                    ?>
              </select>
            </div>
                ...
                <hr class="style_two"/>
                  <div class="form-actions form-actions-padding-sm form-actions-padding-md form-actions-padding-lg" >
                      ...
                      <div class="col-sm-2">
                          <input style="float:right;" type="submit" id="woMod" name="woMod" value="Modifier" class="btn btn-danger btn-lg">
                      </div>
                    <hr class="style_two"/>
                    </div>  
                  </div>
                ...
                if(data.compte>0){
                   for(var i = 0; i< 1000;i++){
                    if(data.id_site[i].length>0){
                        $("#site_id").append("<option value='0' selected='selected'>Choisir</option><option value='"+data.id_site[i]+"'>"+data.nom[i]+"</option>");
                    }
                  }
                }else{
                   $("#site_id").append("<option value='0' selected='selected'>Créer un chantier</option>");
       ...
       $(document).ready(function(){
        ...
        $(document).ready(function(){
          ...
          //  alert($(this).val());
            ...
            //$(this).children("select option:not(:first)").remove();
              if($(this).attr("id")!=0){
                  var id=$(this).attr("id");
