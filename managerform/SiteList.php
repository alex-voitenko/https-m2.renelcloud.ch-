                    ...
                    <div class='box-header red-background'>
                     <div class='title'><p>Sites</p>
                        <div class='actions'>
                          ...
                          <a class="btn btn-md btn-link" href="SiteAdd.php"><i class='icon-plus' ></i> Ajouter un site</a>
                        </div>
					             </div>
                    </div>
                      ...
                      <div class='responsive-table'>
                        ...
                        <div class='scrollable-area'>
                          <table id="example" class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0; width:100%!important;'>
                            <thead>
                              <tr><th>Nom</th><th>Client</th><th>Description</th><th>Modifier</th><th>Supprimer</th></tr>
                            </thead>
                            <tbody>
                              <?php 
                              while($data=$dem->fetch_assoc()){
                                ...
                                <td>
                                  <div class=\"text-right\">
                                    <a class=\"btn btn-warning btn-xs icon-a\" href=\"SiteMod.php?id_mod=$id\">
                                      <i class=\"icon-edit\"></i>
                                    </a>
                                  </div>
                                </td>
