...
var RenelMapFull = (function () {
	...
	var RenelMapFull = function(mapId, type) {
            ...
            this.type = (type!=null) ? type : this.mapType.TRACKING;
...
//                        thisRenelMapFull.setActiveDevice(this.device);
                   ...
                   var html =  '    <div id="info-window" style="background-color: #fff; color:#000; width:250px !important; height: 300px; top:500px; left: 500px; /*border: 1px solid #747272;*/ overflow: hidden !important;">' +
                               '        <div style="overflow: hidden !important">' +
                               '            <div style="display: block; background-color:#ea5a23; margin-bottom: 5px; padding: 5px;">' +
                               '                <div style="padding:5px;">' +
                               '                    <img src="images/android-24.png" style="padding-top: 5px; padding-right: 5px; vertical-align: middle; float: left;"/>' +
                               '                    <div>' +
                               '                        <b style="font-size: larger;">' + device.name + '</b><br/>' +
                               '                        <span style="color:#747272; vertical-align: middle;">Status: inactive</span>' +
                               '                    </div>' +
                               '                </div>' +
                               '            </div>' +
                               '        </div>' +
                               ...
                               '                <img src="images/clock-4-16-orange.png" style="padding-right: 5px; vertical-align: middle;"/>' +
                               '                <span style="color:orange; vertical-align: middle;">' + timestamp + '</span>' +
                               '            </div>' +
                               '            <div style="display: flex; margin-bottom: 5px;">' +
                               '                <img src="images/marker-16.png" style="padding-right: 5px; vertical-align: middle; float: left; height: 50% !important"/>' +
                               '                <div style="color:#0e0; vertical-align: middle; float: right;">' + address + '</div>' +
                               '            </div>' +
                               '            <div style="display: flex; margin-bottom: 5px;">' +
                               '                <img src="images/speedometer-16-red.png" style="padding-right: 5px; vertical-align: middle; float: left; height: 50% !important"/>' +
                               '                <div style="color:#f00; vertical-align: middle; float: right;">' + Number((device.currentLocation.speed * 3.6).toFixed(2)) + ' km/h</div>' +
                               '            </div>' +
                               '            <br/>' +
                               '            <div style="display: flex;">' +
                               '                <img src="images/user-16-black.png" style="padding-right: 5px; vertical-align: middle; float: left; height: 50% !important"/>' +
                               '                <div style="color:#00f; vertical-align: middle; float: right;">' + username + '<br/></div>' +
                               '            </div>' +
                               '            <div style="display: flex;">' +
                               '                <img src="images/phone-51-16-blue.png" style="padding-right: 5px; vertical-align: middle; float: left; height: 50% !important"/>' +
                               '                <div style="color:#00f; vertical-align: middle; float: right;">IMEI: ' + device.imei + '<br/>N°: n.a</div>' +
                               '            </div>' +
                               '            <hr>' +
                               '            <div style="display: flex; position: relative; padding: 0px;">' +
                               '                <div style="border: 1px solid #efefef; width: 45%; height: 50px; margin:auto; float: left;"></div>' +
                               '                <div style="border: 1px solid #efefef; width: 45%; height: 50px; margin:auto; float: right;"></div>' +
                               '            </div>' +
                               '        </div>' +
                               '    </div>';
            ...
            var infoWindow = new google.maps.InfoWindow;
                for(var idx=0; idx<this.deviceHistory.count; idx++) {
                    ...
                    var htmlBgClr = (speed>120) ? "#ff0000" : "transparent";
            ...
            console.log("Executing thisRenelMapFull.refreshDeviceHistoryLocations()...");
                // Loop through markers and set map to null for each
                this.hideMarkers();
                // Reset the markers array
