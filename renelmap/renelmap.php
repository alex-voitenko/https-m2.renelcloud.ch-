...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/renelmapcontrols_style.css">
    <link rel="stylesheet" type="text/css" href="css/renelmap_style.css">
    ...
    <script type="text/javascript" src="js/RenelMapControls.js"></script>
    <script type="text/javascript" src="js/RenelMapFull.js"></script>
        ...
        <div id="content">
            ...
            <div id="panelMap">
                ...
                <div class="panelDevices">
                    ...
                    <div id="list-footer">
                        <img id="close-list" src="images/arrow-89-128_Up.png" onclick="javascript: close_devices_list();"/>
                    </div>
                </div>
